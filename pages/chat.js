            ...
            <div className={styles.frameContainer}>
              <div className={styles.frameWrapper}>
                <div className={styles.ellipseParent}>
                  <Image className={styles.frameChild} alt="" width={60} height={60} style={{borderRadius: '50%'}} src={currentFriendData.profilePic} />
                  <div className={styles.sunnndayyyParent}>
                    <div className={styles.sunnndayyy}>{currentFriendData.username}</div>
                    <div className={styles.ellipseGroup}>
                      <Image className={styles.ethIcon} alt="" src={ethicon} />
                      <div className={styles.xf4844ab5b4fc}>{currentFriendData.address}</div>
                    </div>
                  </div>
                </div>
